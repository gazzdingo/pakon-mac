...
and uses the full 0-255, while ours floors at 60-120. Six tone
...
VENDOR GROUND TRUTH
    PSI's RAW export and its finished render of the same frame are
    PIXEL-REGISTERED (verified: peak |correlation| 0.90 at dy=dx=0), so the
    vendor's end-to-end transform can be MEASURED directly from the pair --
